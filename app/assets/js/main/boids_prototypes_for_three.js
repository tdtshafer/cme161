...
Boid.prototype.create_geometry = function() {
    ...
    **/
    ...
    //torus knot
    this.geometry = new THREE.TorusKnotGeometry( 10, 10, 100, 16 );
...
Boid.prototype.create_material = function() {
    ...
    this.color.setHSL(Math.random(), 0.75, 0.4);
    ...
    **/ 
    ...
    this.material =  new THREE.MeshPhongMaterial( 
           { color: this.color, specular: 0x333333, shininess: 100, transparent: true, opacity: 1 } 
...
Boid.prototype.update_mesh = function() {  
    ...
    **/
    ...
    //
    // I decided to turn this off so I could have colorful boxes! -ts
    //
